...
let userEmail = window.caUser.userEmail;

var emailProvider = userEmail.substring(
userEmail.indexOf("@") + 1, 
  ...
  <widget style="text-align:center;" :title="'Email Verification'">
    <div style="padding-left:25px;padding-right:25px;padding-top:25px;">
      ...
      <div v-else>
        ...
        <div v-if="linkExpired" style="color:red; font-weight:bold;">
          <div style="height:10px;"></div>
          Your confirmation email has expired, please request a new one.
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      status: null,
      errors: null,
      userVerified: window.caUser.userVerified,
      linkExpired: false,
    }
  },
  ...
  mounted() {
    ...
    this.linkExpired = urlParams.get('expired') === 'true';
  }
